...
function calculateTip(amount) {  // - Take in an amount as an argument, then later, when calling the function, use the variable (totalAmount) from above
...
// Bonus, round your amount returned to 2 decimal places.
