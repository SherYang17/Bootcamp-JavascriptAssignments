...
fetchUserById(2)
    .then((user) => {
    console.log("Fetched user:", user); //Log the user object if the promise is fulfilled
    })
    .catch((error) => {
    console.log("Error fetching data:", error); // the error message if the promise is rejected.
});
...
// In this example, we will demonstrate how promises work with the call stack using a simple data fetching function that returns a promise.
